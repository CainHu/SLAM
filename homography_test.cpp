...
int main() {
    ...
    auto flag = reconstruct_from_homography(match_pairs, R_est, t_est, n_est, points, is_outliers, zhang_decomposition);
...
//    cout << "H = " << R_est.determinant() << '\n';
    cout << "H_est = " << R_est + t_est * n_est.transpose() << '\n';
